...
std::vector<int> SimpleTUI::GetActionSeq() {
    cout << "SimpleTUI return action seq: " << actionSeq << endl; 
    return actionSeq;
}

std::vector<ActionVar> SimpleTUI::GetActionVarSeq() {
    cout << "SimpleTUI return action var seq " << action_vars_ << endl;
    return action_vars_; 
}

void SimpleTUI::run(int argc, char *argv[]) {
...
*=========================================*/
  ...
  actionSeq = simulator->ExtractAction();
  action_vars_ = simulator->model()->GetActionVar();

  cout << "actionSeq: " << actionSeq << endl;

  cout << "actionVarSeq: " << action_vars_ << endl; 
