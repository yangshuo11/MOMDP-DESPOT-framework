...
echo_and_run cd "/home/ys/MOMDP_DESPOT/ROSPlan/src/rosplan/rosplan_rqt"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ys/MOMDP_DESPOT/ROSPlan/src/rosplan/rosplan_rqt/setup.py" \
    build --build-base "/home/ys/MOMDP_DESPOT/ROSPlan/build/rosplan/rosplan_rqt" \
    install \
    $DESTDIR_ARG \
