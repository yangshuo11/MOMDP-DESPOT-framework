...
set(MSG_I_FLAGS "-Ibase_local_planner:/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/base_local_planner/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/base_local_planner/msg/Position2DInt.msg" NAME_WE)
add_custom_target(_base_local_planner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "base_local_planner" "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/base_local_planner/msg/Position2DInt.msg" ""
)
...
_generate_msg_cpp(base_local_planner
  "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/base_local_planner/msg/Position2DInt.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_java(base_local_planner
  "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/base_local_planner/msg/Position2DInt.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/base_local_planner
)

### Generating Services

### Generating Module File
_generate_module_java(base_local_planner
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/base_local_planner
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(base_local_planner_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(base_local_planner_generate_messages base_local_planner_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/base_local_planner/msg/Position2DInt.msg" NAME_WE)
add_dependencies(base_local_planner_generate_messages_java _base_local_planner_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(base_local_planner_genjava)
add_dependencies(base_local_planner_genjava base_local_planner_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS base_local_planner_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/base_local_planner)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/base_local_planner
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(base_local_planner_generate_messages_java std_msgs_generate_messages_java)
endif()
