...
set(MSG_I_FLAGS "-Icostmap_2d:/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/costmap_2d/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg;-Imap_msgs:/opt/ros/kinetic/share/map_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/kinetic/share/sensor_msgs/cmake/../msg;-Inav_msgs:/opt/ros/kinetic/share/nav_msgs/cmake/../msg;-Iactionlib_msgs:/opt/ros/kinetic/share/actionlib_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/costmap_2d/msg/VoxelGrid.msg" NAME_WE)
add_custom_target(_costmap_2d_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "costmap_2d" "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/costmap_2d/msg/VoxelGrid.msg" "geometry_msgs/Point32:std_msgs/Header:geometry_msgs/Vector3"
)
...
_generate_msg_cpp(costmap_2d
  "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/costmap_2d/msg/VoxelGrid.msg"
  "${MSG_I_FLAGS}"
...
### Generating Messages
_generate_msg_java(costmap_2d
  "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/costmap_2d/msg/VoxelGrid.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/kinetic/share/geometry_msgs/cmake/../msg/Point32.msg;/opt/ros/kinetic/share/std_msgs/cmake/../msg/Header.msg;/opt/ros/kinetic/share/geometry_msgs/cmake/../msg/Vector3.msg"
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/costmap_2d
)

### Generating Services

### Generating Module File
_generate_module_java(costmap_2d
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/costmap_2d
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(costmap_2d_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(costmap_2d_generate_messages costmap_2d_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/costmap_2d/msg/VoxelGrid.msg" NAME_WE)
add_dependencies(costmap_2d_generate_messages_java _costmap_2d_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(costmap_2d_genjava)
add_dependencies(costmap_2d_genjava costmap_2d_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS costmap_2d_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/costmap_2d)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/costmap_2d
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(costmap_2d_generate_messages_java std_msgs_generate_messages_java)
endif()
if(TARGET geometry_msgs_generate_messages_java)
  add_dependencies(costmap_2d_generate_messages_java geometry_msgs_generate_messages_java)
endif()
if(TARGET map_msgs_generate_messages_java)
  add_dependencies(costmap_2d_generate_messages_java map_msgs_generate_messages_java)
endif()
