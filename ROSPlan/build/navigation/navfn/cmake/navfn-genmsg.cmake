...
get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/SetCostmap.srv" NAME_WE)
add_custom_target(_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "navfn" "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/SetCostmap.srv" ""
)

get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/MakeNavPlan.srv" NAME_WE)
add_custom_target(_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "navfn" "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/MakeNavPlan.srv" "geometry_msgs/Quaternion:geometry_msgs/PoseStamped:geometry_msgs/Pose:std_msgs/Header:geometry_msgs/Point"
)
...
### Generating Services
_generate_srv_java(navfn
  "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/SetCostmap.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/navfn
)
_generate_srv_java(navfn
  "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/MakeNavPlan.srv"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_java(navfn
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/navfn
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(navfn_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(navfn_generate_messages navfn_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/SetCostmap.srv" NAME_WE)
add_dependencies(navfn_generate_messages_java _navfn_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/ys/MOMDP_DESPOT/ROSPlan/src/navigation/navfn/srv/MakeNavPlan.srv" NAME_WE)
add_dependencies(navfn_generate_messages_java _navfn_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(navfn_genjava)
add_dependencies(navfn_genjava navfn_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS navfn_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/navfn)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/navfn
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET geometry_msgs_generate_messages_java)
  add_dependencies(navfn_generate_messages_java geometry_msgs_generate_messages_java)
endif()
