...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_B().pack(self.all_true))
      ...
      for val1 in self.false_knowledge:
        ...
        for val3 in _v34.tokens:
          ...
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        _v36 = val1.ineq
        buff.write(_get_struct_B().pack(_v36.comparison_type))
        _v37 = _v36.LHS
        ...
        for val4 in _v39.tokens:
          ...
          _x = val4
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        buff.write(_get_struct_B().pack(_v36.grounded))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
    ...
    try:
      ...
      for val1 in self.false_knowledge:
        ...
        for val3 in _v50.tokens:
          ...
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        _v52 = val1.ineq
        buff.write(_get_struct_B().pack(_v52.comparison_type))
        _v53 = _v52.LHS
        ...
        for val4 in _v55.tokens:
          ...
          _x = val4
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        buff.write(_get_struct_B().pack(_v52.grounded))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
