...
(cl:in-package rosplan_momdp-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosplan_momdp-msg:<Num> is deprecated: use rosplan_momdp-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_momdp-msg:num-val is deprecated.  Use rosplan_momdp-msg:num instead.")
  (num m))
